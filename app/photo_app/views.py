...
def my_gallery(request):
    ...
    return render(request, 'photo_app/my_gallery.html', context)
...
def handle_photos(request):
    ...
    obj_page = request.GET.get('page',
                               request.POST.get('obj_page', '1'))  # Отримуємо поточну сторінку або 1 за замовчуванням
